...
var dependencies: [Package.Dependency] = [
    .package(url: "https://github.com/IBM-Swift/LoggerAPI.git", from: "1.9.200"),
    .package(url: "https://github.com/IBM-Swift/BlueSocket.git", from: "1.0.200"),
    .package(url: "https://github.com/IBM-Swift/CCurl.git", from: "1.1.200"),
    .package(url: "https://github.com/IBM-Swift/BlueSSLService.git", from: "1.0.200")
]
...
dependencies.append(contentsOf: [
    .package(url: "https://github.com/IBM-Swift/CEpoll.git", from: "1.0.200"),
    .package(url: "https://github.com/IBM-Swift/BlueSignals.git", from: "1.0.200")
    ])
